...
function uploaddetailedcostingcsv() {
    ...
    reader.onload = function (e) {
        ...
        var jsonData = XLSX.utils.sheet_to_json(worksheet, { defval: "", range: 0});
        ...
        if(totalRows > 0) {
          ...
          if(cleanedData.length > 0) {
            cleanedData.forEach((row, index) => {
              add_estimate_item_to_table(row, 'undefined', 'undefined', 'undefined');
            });
            fileInput.value = '';
          }
        }
    ...
    reader.onload = function (e) {
        ...
        if(totalRows > 0) {
          var cleanedData = jsonData.map(row => ({
            ...
            sub_qty: row["Qty"]?.toString() || "0",
            sub_rate: row["(*)Rate"]?.toString() || "0",
          ...
          if(cleanedData.length > 0) {
            cleanedData.forEach((row, index) => {
              add_sub_multilevel_item_to_table(sub_tab, parent_id, row);
            });
            fileInput.value = '';
          }
        }
...
function uploadareaworkingcsv() {
    ...
    reader.onload = function (e) {
        ...
        if(totalRows > 0) {
          ...
          if(cleanedData.length > 0) {
            cleanedData.forEach((row, index) => {
              add_area_working_item_to_table(row, 'undefined', 'undefined', 'undefined');
            });
            fileInput.value = '';
          }
        }
