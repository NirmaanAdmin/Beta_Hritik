...
function add_area_working_item_to_table(data, itemid, merge_invoice, bill_expense) {
  ...
  table_row +=
    ...
    '][area_length]" value="' +
    data.area_length +
    '" class="form-control" id="area_length"></td>';
  ...
  table_row +=
    ...
    '][area_width]" value="' +
    data.area_width +
    '" class="form-control" id="area_width"></td>';
...
function add_area_summary_item_to_table(data, itemid, merge_invoice, bill_expense) {
  ...
  table_row += '<td><textarea name="newareasummaryitems[' +
    item_key +
    '][floor]" class="form-control" rows="4">' +
    data.floor +
    "</textarea></td>";
...
function get_area_summary_item_preview_values(tab) {
  var response = {};
  response.floor = $('#' + tab + ' textarea[name="floor"]').val();
...
function calculate_area_summary_total() {
  ...
  $(".total_area").html(format_money(total_area));
}
