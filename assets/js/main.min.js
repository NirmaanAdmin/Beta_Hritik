...
function calculate_estimate_total(annexure = '') {
  if (empty(annexure)) {
    annexure = $('.tab-pane.active').attr('id');
  }
  var calculated_tax,
    taxrate,
    item_taxes,
...
function add_estimate_item_to_table(data, itemid, merge_invoice, bill_expense) {
  ...
  var annexure_id = $('.tab-pane.active').attr('data-id');
  ...
  ).done(function (tax_dropdown, estimate_unit_dropdown) {
...
function get_area_working_item_preview_values(tab) {
  var response = {};
  response.master_area = $('tbody.area_working select[name="master_area"]').selectpicker("val");
  response.functionality_area = $('tbody.area_working select[name="functionality_area"]').selectpicker("val");
  response.area_description = $('tbody.area_working textarea[name="area_description"]').val();
  response.carpet_area = $('tbody.area_working input[name="carpet_area"]').val();
  response.surface_area = $('tbody.area_working input[name="surface_area"]').val();
  response.carpet_area_unit = $('tbody.area_working select[name="carpet_area_unit"]').selectpicker("val");
  response.surface_area_unit = $('tbody.area_working select[name="surface_area_unit"]').selectpicker("val");
  return response;
}

function clear_area_working_item_preview_values() {
  var previewArea = $('tbody.area_working').find("tr").eq(0);
...
function add_area_working_item_to_table(data, itemid, merge_invoice, bill_expense) {
  ...
  data =
    typeof data == "undefined" || data == "undefined"
      ? get_area_working_item_preview_values()
      : data;

  var table_row = "";
  var item_key = lastAddedItemKey
    ? (lastAddedItemKey += 1)
    : $("body").find("tbody.area_working .item").length + 1;
  lastAddedItemKey = item_key;

  var master_area_name = "newareaworkingitems[" + item_key + "][master_area]";
  var functionality_area_name = "newareaworkingitems[" + item_key + "][functionality_area]";
  var carpet_area_unit_name = "newareaworkingitems[" + item_key + "][carpet_area_unit]";
  var surface_area_unit_name = "newareaworkingitems[" + item_key + "][surface_area_unit]";

  $.when(
    get_master_area_dropdown(master_area_name, data.master_area),
    get_functionality_area_dropdown(functionality_area_name, data.functionality_area),
    get_carpet_area_unit_dropdown(carpet_area_unit_name, data.carpet_area_unit),
    get_surface_area_unit_dropdown(surface_area_unit_name, data.surface_area_unit)
  ).done(function (master_area_dropdown, functionality_area_dropdown, carpet_area_unit_dropdown, surface_area_unit_dropdown) {
    ...
    table_row +=
      ...
      '][carpet_area]" value="' +
      data.carpet_area +
      '" class="form-control" id="carpet_area">' + carpet_area_unit_dropdown[0] + '</td>';
    ...
    table_row +=
      ...
      '][surface_area]" value="' +
      data.surface_area +
      '" class="form-control" id="surface_area">' + surface_area_unit_dropdown[0] + '</td>';
    ...
    $('table.items tbody.area_working').append(table_row);
    ...
    init_datepicker();
    init_color_pickers();
    clear_area_working_item_preview_values();
    return true;
  });
...
function get_carpet_area_unit_dropdown(name, value) {
...
function get_surface_area_unit_dropdown(name, value) {
  return $.post(admin_url + "costplanning/get_area_unit_dropdown", {
    name: name,
    value: value,
  });
...
function calculate_area_working_total() {
  ...
  var total_surface_area = 0;
  var rows = $("tbody.area_working tr.item");
  $.each(rows, function () {
    var carpet_area = $(this).find("#carpet_area").val();
    var surface_area = $(this).find("#surface_area").val();
    carpet_area = parseFloat(carpet_area) || 0;
    surface_area = parseFloat(surface_area) || 0;
    total_carpet_area += carpet_area;
    total_surface_area += surface_area;
  });

  $(".total_carpet_area").html(format_money(total_carpet_area));
  $(".total_surface_area").html(format_money(total_surface_area));
}
...
$('a#tab_area_working').on('shown.bs.tab', function (e) {
  calculate_area_working_total();
});
