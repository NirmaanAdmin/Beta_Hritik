...
function add_area_summary_item_to_table(data, itemid, merge_invoice, bill_expense) {
  ...
  var master_area_name = "newareasummaryitems[" + item_key + "][master_area]";

  $.when(
    get_master_area_dropdown(master_area_name, data.master_area)
  ).done(function (master_area_dropdown) {
    table_row += '<tr class="item">';
    ...
    table_row += '<td>' + master_area_dropdown + '</td>';
...
$('a#tab_area_working').on('click', function (e) {
  calculate_area_working_total();
});
...
$('a#tab_area_summary').on('click', function (e) {
  calculate_area_summary_total();
});
