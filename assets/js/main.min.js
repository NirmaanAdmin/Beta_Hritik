...
function add_sub_multilevel_item_to_table(sub_tab, parent_id, data = 'undefined') {
  ...
  $.when(
    ...
    table_row +=
      '<td><input type="number" min="0" onblur="calculate_sub_multilevel_total(\''+sub_tab+'\');" onchange="calculate_sub_multilevel_total(\''+sub_tab+'\');" data-quantity name="newsubintitems[' +
      item_key +
      '][sub_qty]" value="' +
      data.sub_qty +
      '" class="form-control">' + estimate_unit_dropdown[0] + '</td>';
