...
The supplier will export quality packaging and ship all goods in industry standards as may be applicable to ensure that the goods are received by the buyer in good condition. The applicable Changee Order number must appear on all shipping containers, packing lists, delivery tickets, and Invoice.<br><br>
...
(b) All material & accessories should be delivered as per changee order only and subject to MAS/ Consultant approval.<br>
...
Annexure B (Special conditions of changee)<br>
Annexure C (General terms & conditions of changee)<br><br>

We hereby acknowledge and accept the changee order and the annexures.<br><br>
...
<td style="height: 92.8px;"><span style="color: rgb(0,0,0); font-family: verdana, geneva, sans-serif; font-size: 10pt;"><b><span class="Apple-tab-span">W</span>e hereby acknowledge and accept the changee order</b></span></td>
</tr>
<tr>
<td>
...
Acknowledgment of this Changee Order, invoices, and commercial correspondence shall be sent by courier to the above address, attention Rupesh, with a scanned copy sent by mail to <strong>bgj.project@basilius.in</strong>.<br>
...
';
          ...
          3.2 Delivery terms of this Changee Order shall be interpreted in accordance with 'Incoterms (International Rules for the Interpretation of Trade Terms) 2000' and any amendment and supplement thereto.<br><br>
...
23.2 Subject to Clause 22, the Changeer and the Vendor irrevocably submit to the exclusive jurisdiction of any competent Court situated at Goa on all matters arising out of, concerning to, or related with this Order and waive any objection to such proceedings having been brought in an inconvenient forum.<br><br>
