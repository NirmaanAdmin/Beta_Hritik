...
class changee extends AdminController
{
        ...
        if ($id != '') {
            ...
            if (count($data['pur_request_detail']) > 0) {
                ...
                foreach ($data['pur_request_detail'] as $request_detail) {
                    ...
                    $changee_request_row_template .= $this->changee_model->create_changee_request_row_template('items[' . $index_request . ']', $request_detail['item_code'], $item_text, $request_detail['description'], $request_detail['unit_price'], $request_detail['quantity'], $unit_name, $request_detail['unit_id'], $request_detail['into_money'], $request_detail['prd_id'], $request_detail['tax_value'], $request_detail['total'], $request_detail['tax_name'], $request_detail['tax_rate'], $request_detail['tax'], true, $currency_rate, $to_currency);
                }
            }
        }
        ...
        if ($inv && isset($inv->items)) {
            if (count($inv->items) > 0) {
                ...
                foreach ($inv->items as $key => $item) {
                    ...
                    $list_item .= $this->changee_model->create_changee_request_row_template('newitems[' . $index_request . ']', $item_code, $item_text, $unit_price, $item['qty'], $unit_name, '', $into_money, $index_request, $tax_value, $total, $tax_name, $tax_rate, $tax, false, $currency_rate, $to_currency);
                }
            }
        }
    ...
    public function get_changee_request_row_template()
    {
        ...
        echo $this->changee_model->create_changee_request_row_template($name, $item_code, $item_text, $item_description, $unit_price, $quantity, $unit_name, $unit_id, $into_money, $item_key, $tax_value, $total, $tax_name, '', '', false, $currency_rate, $to_currency);
    }
