<table>
    <tbody>
        ...
        foreach ($list_id as $key => $id) {
            ...
            $current_quantity = isset($get_item_quantity[$key]['quantities']) ? $get_item_quantity[$key]['quantities'] : 0;
            $current_unit_id = isset($get_item_quantity[$key]['unit_id']) ? $get_item_quantity[$key]['unit_id'] : 0;
            ?>
            <tr>
                <td width="50%">
                    <?php
                    ...
                    if ($item_data) {
                    ?>
                        <img src="<?php echo $this->warehouse_model->fe_get_item_image_qrcode_pdf($item_data->id, $vendor, $pur_order, $project_name, $log_desc, $current_quantity, $current_unit_id); ?>" width="400">
                    <?php } ?>
                </td>
                <td width="50%">
